...
help: ## Show this help message
	...
	@echo "  make test-integration - Run integration tests (medium speed)"
	@echo "  make test-performance - Run performance benchmarks"
	@echo "  make test-all         - Run all tests (unit, integration, performance)"
	@echo "  make test-coverage    - Run tests with coverage report (htmlcov/index.html)"
	@echo ""
	...
	@echo "  make test-unit         - Verify core components work"
	@echo "  make test-all          - Run full test suite"
	@echo "  make test-coverage     - Check code coverage"
	@echo ""
